...
Original file is located at
    https://colab.research.google.com/drive/1t4peta90dA5rNI-yJcbTdOiXoXsphV7Y
...
d = stretch(b, 1, 2) # stretch horizontally by a factor of 1/2
...
v = np.array([1.5, 0.5])
w = np.array([1, -2.75])
ellipse_matrix = np.array([v, w]).T

# Calculate the area of the ellipse using the determinant of A
ellipse_area = np.pi * abs(np.linalg.det(ellipse_matrix))
